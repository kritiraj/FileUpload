...
var _createFireHydrant = (0, _createFireHydrant3.default)({ serializers: [(0, _createImmutableSerializer2.default)()] }),
    toHydrant = _createFireHydrant.toHydrant,
    fromHydrant = _createFireHydrant.fromHydrant,
    serialize = _createFireHydrant.serialize,
    deserialize = _createFireHydrant.deserialize;
